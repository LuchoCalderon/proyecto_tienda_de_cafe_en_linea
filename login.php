          ...
          <div class="card-body p-4">
            ...
            <form>
              ...
              <div class="d-grid gap-2 mb-4">
                <a class="btn btn-primary" href="pantalla_error.php">Iniciar Sesión sin Autenticación</a>  
              </div>

              <div class="d-grid gap-2 mb-4">
                <a class="btn btn-primary" href="perfilUsuario.php">Iniciar Sesión con Autenticación</a>  
              </div>

              <div class="d-grid gap-2">
                <a class="btn btn-primary" href="administrador.php">Iniciar Sesión Administrador</a>  
              </div>
